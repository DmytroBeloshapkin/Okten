...
let firstSymbol2 = str => str[0].toUpperCase()+str.slice(1); // другий варіант

console.log(firstSymbol2(str));

//************************************************************************
// - Напишіть функцію capitalize(str), яка повертає рядок, у якому кожне слово починається з великої літери.
let firstSymbolPro = str => {
    let firstPro = str.split(' ').map(item => item[0].toUpperCase().concat(item.slice(1))).join(' '); // мало що зрозумів)
    return firstPro;
}
